...
回答的問題:
  ...
  - 不同分解法的差異:svd 有正有負(數學基底),
    semi-NMF 全正且帶底盤(混進連續譜成分)
...
用法:
    ...
    python src/skymodel/tools/plot_basis.py --basis seminmf --ylim-sky 0 60
"""
import argparse
...
def main():
    ...
    ap.add_argument("--basis", default="svd", help="pca / svd / nmf / seminmf / seminmf_mean / rpca")
    ...
    out = FIGURES / f"basis_{args.basis}"
