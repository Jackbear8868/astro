...
blank 是用「白光影像上的 SExtractor 偵測」界定的(教授指定)。但 Haro 11 的
電離氣體暈是「只有發射線、沒有連續譜」的 —— 它對寬波段白光幾乎沒有貢獻,
在光譜裡卻完整存在。算術上也對不起來:

    cube 332x320 = 106,240 spaxel,blank(seg=0) = 85,105 → 只遮掉 21,135
    Menacho+2019 量到的 Ha 暈延伸 5x5 kpc,本專案記錄 Ø ~ 226 px → 面積 ~40,100
