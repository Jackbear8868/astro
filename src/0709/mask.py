...
mask — 讀取既有 source mask，做後處理，存成新方法名（不覆蓋原始版本）。
  ...
  跑法： conda run -n astro python src/0709/mask.py --from-cube NEnosky --method seg1sigma
         conda run -n astro python src/0709/mask.py --from-cube NEnosky --method seg2sigma
