...
conda run -n astro python src/0709/mask.py --from-cube NEnosky --method seg1sigma

# ZAP 扣天空
conda run -n astro python src/0709/zap.py --target NEwsky --mask-from NEnosky --mask-method seg1sigma_brq --ncpu 16
